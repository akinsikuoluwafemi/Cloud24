...
/*!********************!*\
  !*** ./src/app.js ***!
  \********************/
/*! exports provided: deleteRecentLocation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteRecentLocation\", function() { return deleteRecentLocation; });\n/* harmony import */ var _models_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Search */ \"./src/models/Search.js\");\n/* harmony import */ var _views_searchView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/searchView */ \"./src/views/searchView.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/base */ \"./src/views/base.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_3__);\n\n\n\n\n\n\n// global state of the app\n// >search Object\n// >Recent location\n// >extended forcast\nconst state = {};\n\n// a function that will be ran anytime we submit the form\nconst controlSearch = async () => {\n    // get the query from the view\n    const query = _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"getInput\"]();\n    console.log(query);\n\n    if (query) {\n        // New Search object and add it to state\n        state.search = new _models_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"](query);\n\n        //  Clear Previous inputs and previous result\n        _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"clearInput\"]();\n        _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"clearInputPrevResForDays\"]();\n        _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"clearInputPrevResForHours\"]();\n\n        // render the loading spinner\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_2__[\"renderLoader\"])(_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].search);\n\n        // wait for the two results to arrive\n        await state.search.getWeatherHours('forecast_hourly', 'DemoAppId01082013GAL', 'AJKnXv84fjrb0KIHawS0Tg');\n        await state.search.getWeatherDays('forecast_7days', 'DemoAppId01082013GAL', 'AJKnXv84fjrb0KIHawS0Tg');\n        await state.search.getAlerts('alerts', 'DemoAppId01082013GAL', 'AJKnXv84fjrb0KIHawS0Tg');\n\n        // clear the loader after the results have arrived\n        Object(_views_base__WEBPACK_IMPORTED_MODULE_2__[\"clearLoader\"])();\n        // insert the two search results in the state\n        _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderWeatherHours\"](state.search.resultHours);\n\n        _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"recentLocation\"](state.search.resultHours, query.toUpperCase());\n\n        _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderWeathersDays\"](state.search.resultDays);\n        // searchView.renderWeatherAlerts(state.search.resultDays);\n        _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchInput.value;\n\n        //  change textContent of the location text\n\n        _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchLocation.textContent = query.split(' ', 2).join(' ').toUpperCase();\n        console.log(state);\n    }\n};\n\n_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchForm.addEventListener('submit', e => {\n    e.preventDefault();\n    controlSearch();\n});\n\n_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchInput.addEventListener('blur', e => {\n    console.log('you just blurred');\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].showSearch.classList.add('show');\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].list.classList.add('show');\n});\n\n_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchInput.addEventListener('input', e => {\n    console.log('you just focused out');\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].showSearch.classList.remove('show');\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].list.classList.remove('show');\n});\n\nlet findMatches = (wordToMatch, cities) => {\n    return cities.filter(place => {\n        const regex = new RegExp(wordToMatch, 'gi');\n        return place.match(regex);\n    });\n};\n\nfunction displayMatches() {\n    const matchArray = findMatches(this.value, _views_base__WEBPACK_IMPORTED_MODULE_2__[\"countries\"]);\n    const html = matchArray.map(place => {\n        const regex = new RegExp(this.value, 'gi');\n        const cityName = place.replace(regex, `<span class=\"h1\">${this.value}</span>`);\n        return `\n                <li class=\"list-span\"><span>${cityName}</span></li>\n            \n        `;\n    }).join('');\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].showSearch.innerHTML = html;\n}\n\n_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchInput.addEventListener('change', () => {\n    displayMatches();\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].showSearch.style.zIndex = '-1';\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].showSearch.style.opacity = '0';\n});\n_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchInput.addEventListener('keyup', displayMatches);\n\n// come back here :)\n_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchInput.addEventListener('input', () => {\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].showSearch.style.zIndex = '2';\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].showSearch.style.opacity = '1';\n});\n\n// whenever you scroll the window 20px downward the navigation will be fixed\n//   This example demonstrates how to slide down a navbar when the user starts to scroll the page\nfunction checkScroll() {\n    if (document.body.scrollTop > 30 || document.documentElement.scrollTop > 30) {\n        _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].header.style.top = '0';\n    } else {\n        _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].header.style.top = '-150px';\n    }\n}\n\nwindow.onscroll = checkScroll;\n\n// what happens any time the page loads\n\n\nconst random = Math.floor(Math.random() * _views_base__WEBPACK_IMPORTED_MODULE_2__[\"countries\"].length);\n\nasync function hoursAlertOnDomLoad(query) {\n\n    const proxy = `https://cors-anywhere.herokuapp.com/`;\n    const request = await axios__WEBPACK_IMPORTED_MODULE_3___default()(`${proxy}https://weather.cit.api.here.com/weather/1.0/report.json?product=forecast_hourly&name=${query}&app_id=DemoAppId01082013GAL&app_code=AJKnXv84fjrb0KIHawS0Tg`);\n\n    let { data } = request;\n    let { hourlyForecasts } = data;\n    let { forecastLocation } = hourlyForecasts;\n    let { forecast } = forecastLocation;\n\n    _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderHoursOnDomLoad\"](forecast);\n    _views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchLocation.textContent = query.split(' ', 2).join(' ');\n}\ndocument.addEventListener('DOMContentLoaded', hoursAlertOnDomLoad(_views_base__WEBPACK_IMPORTED_MODULE_2__[\"countries\"][random]));\n\nasync function dayAlertOnDomLoad(query) {\n    const proxy = `https://cors-anywhere.herokuapp.com/`;\n\n    const request = await axios__WEBPACK_IMPORTED_MODULE_3___default()(`${proxy}https://weather.cit.api.here.com/weather/1.0/report.json?product=forecast_7days&name=${query}&app_id=DemoAppId01082013GAL&app_code=AJKnXv84fjrb0KIHawS0Tg`);\n\n    let { data } = request;\n    let { forecasts } = data;\n    let { forecastLocation } = forecasts;\n    let { forecast } = forecastLocation;\n    _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderDaysOnDomLoad\"](forecast);\n}\n\ndocument.addEventListener('DOMContentLoaded', dayAlertOnDomLoad(_views_base__WEBPACK_IMPORTED_MODULE_2__[\"countries\"][random]));\n\n_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].searchInput.value;\n\nconst deleteRecentLocation = el => {\n    if (el.classList.contains('delete')) {\n        el.parentElement.parentElement.parentElement.remove();\n    }\n};\n\n_views_base__WEBPACK_IMPORTED_MODULE_2__[\"elements\"].recentLocation.addEventListener('click', e => {\n    _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"removeEl\"](e.target);\n});\n\n//# sourceURL=webpack:///./src/app.js?");
...
/*!***************************!*\
  !*** ./src/views/base.js ***!
  \***************************/
/*! exports provided: elements, elementStrings, renderLoader, clearLoader, countries */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"elements\", function() { return elements; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"elementStrings\", function() { return elementStrings; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderLoader\", function() { return renderLoader; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearLoader\", function() { return clearLoader; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"countries\", function() { return countries; });\n// bASE IS WHERE YOU PUT THE STYLES THAT ARE RESUSABLE AND ARE USED ACROSS IN ALL THE MODULES\n\nconst elements = {\n    searchForm: document.querySelector('.search-form'),\n    searchInput: document.querySelector('.search-form-input'),\n    searchLocation: document.querySelector('.location-text'),\n    searchCurCondition: document.querySelector('.current-condition'),\n    currentWrapper: document.querySelector('.current-wrapper'),\n    extendedForc: document.querySelector('.extended-forecast'),\n    spinner: document.querySelector('.spinner'),\n    search: document.querySelector('.search'),\n    searchResPages: document.querySelector('.outer-wrapper'),\n    goButton: document.querySelector('.btn-container'),\n    header: document.querySelector('.header'),\n    showSearch: document.querySelector('.div-show'),\n    list: document.querySelector('.list-span'),\n    delete: document.querySelector('.delete'),\n    recent: document.querySelector('.time-wrapper'),\n    recentLocation: document.querySelector('.recent-location'),\n    heading: document.querySelector('.heading'),\n    t: document.querySelector('.t')\n\n};\n\nconst elementStrings = {\n    loader: 'spinner'\n};\n\nconst renderLoader = parent => {\n    const spinner = `\n            <i class=\"fas fa-circle-notch fa-4x ${elementStrings.loader}\"></i>\n\n    `;\n    parent.insertAdjacentHTML('afterbegin', spinner);\n};\n\nconst clearLoader = () => {\n    const loader = document.querySelector(`.${elementStrings.loader}`);\n\n    if (loader) loader.parentElement.removeChild(loader);\n};\n\nconst countries = ['Albania', 'Algeria', 'Andorra', 'Angola', 'Argentina', 'Armenia', 'Australia', 'Austria', 'Azerbaijan', 'Bahamas', 'Bahrain', 'Bangladesh', 'Belarus', 'Belgium', 'Benin', 'Bolivia', 'Botswana', 'Brazil', 'Bulgaria', 'Burkina Faso', \"Côte d'Ivoire\", 'Cabo Verde', 'Cambodia', 'Canada', 'Chad', 'Chile', 'China', 'Colombia', 'Comoros', 'Costa Rica', 'Cuba', 'Cyprus', 'liverpool', 'Manchester', 'Bolton', 'Avana', 'Czech Republic', 'Denmark', 'Djibouti', 'Dominican Republic', 'Ecuador', 'Ibadan', 'Monaco', 'Abuja', 'Calabar', 'Egypt', 'El Salvador', 'Equatorial Guinea', 'Eritrea', 'New York', 'New Mexico', 'New Orleans', 'Louisiana', 'New Jersey', 'New Haven', 'New Hampshire', 'Porto', 'Phoenix', 'San Jose', 'Texas', 'Florida', 'Chicago', 'Illinois', 'Rochester', 'Virginia', 'Estonia', 'Ethiopia', 'San Francisco', 'Indianapolis', 'Hong Kong', 'Fiji', 'Utah', 'Michigan', 'Oklahoma', 'Lowa', 'Finland', 'France', 'Gabon', 'Gambia', 'Georgia', 'Germany', 'Ghana', 'Greece', 'Grenada', 'Guatemala', 'Guinea', 'Haiti', 'Honduras', 'Hungary', 'Iceland', 'India', 'Indonesia', 'Iran', 'Iraq', 'Ireland', 'Israel', 'Italy', 'Jamaica', 'Japan', 'Jordan', 'Kazakhstan', 'Kenya', 'Kuwait', 'Laos', 'Lebanon', 'Liberia', 'Luxembourg', 'Madagascar', 'Malawi', 'Malaysia', 'Mali', 'Malta', 'Mauritania', 'Mauritius', 'Moldova', 'Monaco', 'Mongolia', 'Montenegro', 'Morocco', 'Mozambique', 'Netherlands', 'New Zealand', 'Niger', 'Nigeria', 'North Korea', 'North Macedonia', 'Norway', 'Oman', 'Pakistan', 'Panama', 'Papua New Guinea', 'Paraguay', 'Peru', 'Philippines', 'Poland', 'Portugal', 'Qatar', 'Romania', 'Russia', 'Rwanda', 'Saint Kitts and Nevis', 'Saint Lucia', 'San Marino', 'Saudi Arabia', 'Senegal', 'Seychelles', 'Sierra Leone', 'Singapore', 'Slovakia', 'Solomon Islands', 'Somalia', 'South Africa', 'South Korea', 'Spain', 'Sri Lanka', 'Sudan', 'Sweden', 'Switzerland', 'Syria', 'Tanzania', 'Togo', 'Tunisia', 'Turkey', 'United Arab Emirates', 'United Kingdom', 'United States of America', 'Uruguay', 'Venezuela', 'Lagos', 'Sagamu', 'Ikeja', ' Beijing', 'Shanghai', 'Karachi', 'Istanbul', 'Dhaka', 'Tokyo', 'Moscow', 'Manila', 'Tianjin', 'Mumbai', 'Delhi', 'Buenos Aires', 'Guangzhou', 'Kinshasa', 'Manila', 'Tianjin', 'Boston', 'Madrid', 'Toronto', 'Singapore', 'Sydney', 'Johannesburg', 'St Petersburg', 'Barcelona ', 'Napoli', 'Nairobi', 'Cape Town', 'Montreal'];\n\n//# sourceURL=webpack:///./src/views/base.js?");
